...
/**
 * fusion theme — built by `npx astryx theme build`
...
export const fusionTheme = {
  ...
  tokens: {
    ...
    "--color-background-body": "light-dark(#F0F0F9, #111018)",
    ...
    "--color-accent": "light-dark(#0055D9, #C0C1FF)",
    ...
    "--color-text-secondary": "light-dark(#464652, #AAAAB8)",
    "--color-text-disabled": "light-dark(#908F9D, #5E5D6A)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#111111",
    "--color-on-accent": "light-dark(#FFFFFF, #002A87)",
    ...
    "--color-icon-secondary": "light-dark(#464652, #AAAAB8)",
    ...
    "--color-border": "light-dark(#1B1B221A, #F0F0F91A)",
    "--color-border-emphasized": "light-dark(#908F9D, #676774)",
    "--color-skeleton": "light-dark(#AAAAB8, #464652)",
    ...
    "--color-track": "light-dark(#AAAAB8, #464652)"
  },
  localTokens: {
  ...
  __localTokenLineage: ["neutral","fusion"],
  components: {
    "heading": {
      "level:1": {
